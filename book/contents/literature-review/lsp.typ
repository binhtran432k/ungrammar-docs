...
#figure(
  ...
  caption: [Language provider and tooling vender relationship ],
) <fig-pre-lsp>
...
- *code*: This value MUST be an integer value and represents the error type that occurred. You can read more on the error codes in the #gls("json-rpc") Specification.
