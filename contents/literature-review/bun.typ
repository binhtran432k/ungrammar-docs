...
and task running, Bun streamlines the development workflow and enhances
developer productivity @bib-bun.

By leveraging Bun's capabilities, developers can build high-performance and
feature-rich language servers with improved development efficiency. In the
following subsections, we will delve into specific aspects of Bun that make it
a suitable choice for #gls("lsp") development.
