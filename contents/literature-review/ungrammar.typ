...
achieve efficient parsing and analysis.

=== Ungrammar in Rust Analyzer

Ungrammar is a #gls("dsl") developed by the Rust Analyzer team to define the
syntax structure of the Rust programming language. It serves as a declarative
way to specify the grammar rules without delving into the complexities of
parser implementation @bib-ungrammar.
